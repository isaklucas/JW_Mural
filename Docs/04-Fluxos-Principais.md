...
- **Retenção:** todo backup bem-sucedido chama `limpar_backups_antigos(90)` — apaga pastas de backup com mais de 90 dias (nome fora do padrão `AAAA-MM-DD*` é ignorado).
