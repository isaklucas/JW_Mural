...
| Documento | Conteúdo |
|------------|----------|
| [01-Arquitetura.md](01-Arquitetura.md) | Visão geral: entrada, camadas (UI em `views/`, `services/`, process, database, util, tests) e fluxo de dados. |
...
| [03-Modulos.md](03-Modulos.md) | Descrição de cada módulo/pasta: `layout`, `views/`, `services/`, `database`, `process`, `util`, `tests/`, assets, Templates. |
